        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <hr />
              {/* Date/Time */}
              <p>โพสต์เมื่อวันที่ 18 ธันวาคม 2567 โดยน.ส.ณัฐกานต์ แสนคำมู</p>
              <hr />
              {/* Post Content */}
              <p className="lead">
                  ...
                  <li>
                    ...
                    <ul className="ml-4" style={{ listStyleType: "circle" }}>
                      <li>
                        {" "}
                        Refreezing:
                        การรักษาผลของการเปลี่ยนแปลงเป็นขั้นตอนที่ทำให้สมาชิกในองค์การแสดงพฤติกรรมใหม่ที่สอดคล้องกับการเปลี่ยนแปลงองค์การด้วยกิจกรรมพัฒนาองค์การในขั้นตอน
                ...
                <ol className="ml-4" style={{ listStyleType: "deciml" }}>
                  <li>
                    ...
                    <ul className="ml-4" style={{ listStyleType: "circle" }}>
                      <li>
                        Negative Deviance
                        การเบี่ยงเบนเชิงลบสถานะไม่สามารถปฏิบัติหน้าที่ได้ตามปกติ
                        (Dysfucntion State) 
                      </li>
              ...
              <li>การยึดมั่นในมาตรฐานสูงสุดของจริยธรรมและอาชีพ (Commitment)</li>
